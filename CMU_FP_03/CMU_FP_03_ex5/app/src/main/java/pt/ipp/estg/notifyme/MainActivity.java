...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void createNotification() {
        ...
        mBuilder.addAction(R.drawable.notification, "Atualizar notificação", pendingUpdateNotification);

        //Desativa os botões ao fazer swipe ou clear all da notificação
        Intent disableButtons = new Intent();
        disableButtons.setAction(ACTION_DISABLE);

        PendingIntent pendingDisableButtons = PendingIntent.getBroadcast(this, 0, disableButtons, 0);

        //Para apagar a notificação ao fazer swipe ou clear all
        mBuilder.setDeleteIntent(pendingDisableButtons);
