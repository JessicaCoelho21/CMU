...
public class ExampleInstrumentedTest {
    @Rule
    public ActivityTestRule<MainActivity> activityScenarioRule = new ActivityTestRule<MainActivity>(MainActivity.class);
    ...
    public void scrollToItemBelowFold_checkItsText() {
        ...
        onView(withId(R.id.text_view)).check(matches(withText(itemElementText)));
    }
}
